...
Shared logical model for the [w6w](https://github.com/w6w-io/w6w-core) workflow
platform — the TypeScript types for its core primitives.

Pure, dependency-free TypeScript. Consumable from Node, Deno, bundlers, and the
runtime alike. App authors use it to write strongly-typed actions and auth
methods; hosts and the editor use it to render and validate.
